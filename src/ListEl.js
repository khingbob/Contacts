...
var counter = 0;
var list = ["BobDaBodybuilder", "Nina", "Emily", "Jessy", "Maggy", "Katrina", "Arnold Weißnegger", "Will мать его Smith", "Zuzu", "BCUM", "DO NOT PICK UP!", "ZuckerMutti ❤️", "The Indian Guy", "Yazan's mom"];
var contacts = {};
for (var i in list) {
    contacts[list[i]] = { "phone": "(+69) 420 696969", "email": "mrbobdaprogrammer@gmail.com" }
}
        ...
        return (
            <div className="listElCont" >
                <div className="name" onClick={(e) => {
                    ...
                    <span className="nameValue" id={nameid}>{list[counter++ % 14]}</span>
                    <img onClick={(e) => { destroy(e, props.miaObj, nameValue) }} className="trash" src={require("./media/trash.png")} />
                </div>
                <div className="details" id={newid}>
                    ...
                    <div className="phone" id={phoneid} onClick={(e) => {
                    ...
                    <div className="email"><a href="mailto: mrbobdaprogrammer@gmail.com">mrbobdaprogrammer@gmail.com</a></div>
                </div>
            </div>
        )
    }
    return (
        <div className="listElCont">
            <div className="name" onClick={(e) => {
                ...
                <span className="nameValue" id={nameid}>{id("searchBar").value}</span>
                <img onClick={(e) => { destroy(e, props.miaObj, id("searchBar")) }} className="trash" src={require("./media/trash.png")} />
            </div>
            <div className="details" id={newid}>
                <div className="copied" id={copid}>
                    Copied ☑️
                ...
                <div className="email"><a href={"mailto:" + getDets[1]}>{getDets()[1]}</a></div>
            </div>
        </div>
    )
}
